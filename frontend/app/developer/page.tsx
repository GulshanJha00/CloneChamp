    ...
    <section className="w-full min-h-screen bg-gray-950 flex items-center justify-center p-6">
      <div className="text-center">
        ...
        <p className="text-sm sm:text-base text-gray-400">
          🔒 Developer Zone — access restricted
        </p>
        ...
        <Link
          ...
          className="inline-flex items-center mt-6 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm sm:text-base font-medium transition"
        >
          Continue
